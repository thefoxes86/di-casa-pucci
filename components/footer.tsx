        ...
        <div className="pb-28 flex flex-col items-center">
          ...
          <div className="flex flex-wrap content__certificazioni p-4">
            <AnimateSection className="w-1/4 flex flex-col items-center justify-center px-4">
              <img
                src="http://backend.dicasapucci.com/wp-content/uploads/2023/05/logo-hi@2x.png"
            ...
            >
              <img
                src="http://backend.dicasapucci.com/wp-content/uploads/2023/05/DicasaPucci_IDC_Logo@2x@2x.png"
                alt="certificazione 1"
              />
              <p className="font-thin py-3 text-center text-xs h-20 !mb-0">
            ...
            >
              <img
                src="http://backend.dicasapucci.com/wp-content/uploads/2023/05/DicasaPucci_FCI_Logo@2x@2x.png"
                alt="certificazione 1"
              />
              <p className="font-thin py-3 text-center text-xs h-20  !mb-0">
            ...
            >
              <img
                src="http://backend.dicasapucci.com/wp-content/uploads/2023/05/DicasaPucci_ENCI_Logo@2x@2x.png"
                alt="certificazione 1"
              />
              <p className="font-thin py-3 text-center text-xs h-20  !mb-0">
